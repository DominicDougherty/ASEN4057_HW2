...
%%input parameters to set (specific to data file)
 prn=str2double(prn);  %GPS satellite number (03 05 06 09 12 14 18 21 22 30 31 )
 msec_to_process = str2double(msec_to_process);  %msec of data to process
 fs=str2double(fs);  %sampling frequency
 intfreq=str2double(intfreq);  %intermediate frequency
